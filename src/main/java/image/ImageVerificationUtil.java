...
import image.exception.ServiceException;
import image.exception.code.ServiceExceptionCode;
...
//        int VERIFICATION_IMAGE_HEIGHT = verificationImage.getHeight();
     ...
     */
    public static ImageVerificationVo pictureTemplateCutout(BufferedImage originImage, InputStream inputStream, String originImageFileType, BufferedImage templateImage, String templateImageFileType, int x, int y) throws ServiceException {
        ImageVerificationVo imageVerificationVo = null;
...
//                    shadeImage.setRGB(x + i, y + j, originRGB);
     ...
     * @throws ServiceException
     */
    private static BufferedImage getInterestArea(int x, int y, int templateImageWidth, int templateImageHeight, InputStream inputStream, String originImageType) throws ServiceException {
