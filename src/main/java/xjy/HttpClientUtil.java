...
public class HttpClientUtil {
     ...
     * @return
     */
    public static String doPostJson2(String url, String postContent, Map<String, String> headers,String errorUrl) {
        if (StringUtils.isEmpty(url)) {
            return null;
        }
        try {

            HttpPost httpPost = new HttpPost(errorUrl);
            config(httpPost);
    ...
    public static Map<String, String> getLiveDefaultHeaders() {
        ...
        headerds.put("Xiao-User-Agent", "");
        headerds.put("X-App-Id", "");
